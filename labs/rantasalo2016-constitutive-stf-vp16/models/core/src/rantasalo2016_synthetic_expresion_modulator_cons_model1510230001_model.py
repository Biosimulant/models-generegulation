...
"""Tellurium-backed SBML wrapper for Rantasalo2016 - Synthetic expresion modulator constitutive STF_VP16."""
...
class Rantasalo2016SyntheticExpresionModulatorConsModel1510230001Model(TelluriumSBMLBioModule):
    _SBML_ID = 'MODEL1510230001'
    _TITLE = 'Rantasalo2016 - Synthetic expresion modulator constitutive STF_VP16'
    ...
    def __init__(self, model_path: str = 'data/MODEL1510230001.xml', integration_step: float = 0.1) -> None:
