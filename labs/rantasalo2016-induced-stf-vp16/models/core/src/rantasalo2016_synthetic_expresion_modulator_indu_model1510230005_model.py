...
"""Tellurium-backed SBML wrapper for Rantasalo2016 - Synthetic expresion modulator induced STF_VP16."""
...
class Rantasalo2016SyntheticExpresionModulatorInduModel1510230005Model(TelluriumSBMLBioModule):
    _SBML_ID = 'MODEL1510230005'
    _TITLE = 'Rantasalo2016 - Synthetic expresion modulator induced STF_VP16'
    ...
    def __init__(self, model_path: str = 'data/MODEL1510230005.xml', integration_step: float = 0.1) -> None:
