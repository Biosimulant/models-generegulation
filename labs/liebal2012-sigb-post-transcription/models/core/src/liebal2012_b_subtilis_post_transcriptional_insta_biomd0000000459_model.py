...
"""Tellurium-backed SBML wrapper for Liebal2012 - B.subtilis post-transcriptional instability model."""
...
class Liebal2012BSubtilisPostTranscriptionalInstaBiomd0000000459Model(TelluriumSBMLBioModule):
    _SBML_ID = 'MODEL1302080001'
    _TITLE = 'Liebal2012 - B.subtilis post-transcriptional instability model'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000459.xml', integration_step: float = 0.1) -> None:
