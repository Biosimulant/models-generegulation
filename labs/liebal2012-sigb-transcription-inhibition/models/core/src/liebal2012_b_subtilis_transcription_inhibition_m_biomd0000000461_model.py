...
"""Tellurium-backed SBML wrapper for Liebal2012 - B.subtilis transcription inhibition model."""
...
class Liebal2012BSubtilisTranscriptionInhibitionMBiomd0000000461Model(TelluriumSBMLBioModule):
    _SBML_ID = 'MODEL1212180000'
    _TITLE = 'Liebal2012 - B.subtilis transcription inhibition model'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000461.xml', integration_step: float = 0.1) -> None:
