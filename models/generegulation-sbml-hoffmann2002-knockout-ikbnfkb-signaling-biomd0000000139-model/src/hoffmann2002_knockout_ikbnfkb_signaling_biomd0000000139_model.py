...
"""Auto-generated SBML BioModule wrapper for Hoffmann2002_KnockOut_IkBNFkB_Signaling.

Source: biomodels_ebi:BIOMD0000000139
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000139
"""
...
class SbmlHoffmann2002KnockoutIkbnfkbSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Hoffmann2002_KnockOut_IkBNFkB_Signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000139.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hoffmann2002KnockoutIkbnfkbSignalingBiomd0000000139Model = SbmlHoffmann2002KnockoutIkbnfkbSignaling
