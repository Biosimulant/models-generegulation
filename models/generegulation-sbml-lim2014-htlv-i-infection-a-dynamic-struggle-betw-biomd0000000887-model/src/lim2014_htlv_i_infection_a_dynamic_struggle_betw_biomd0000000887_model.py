...
"""Auto-generated SBML BioModule wrapper for Lim2014 - HTLV-I infection A dynamic struggle between viral persistence and host immunity.

Source: biomodels_ebi:BIOMD0000000887
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000887
"""
...
class SbmlLim2014HtlvIInfectionADynamicStruggleBetweenViral(biosim.BioModule):
    """BioModule wrapper for SBML model: Lim2014 - HTLV-I infection A dynamic struggle between viral persistence and host immunity."""

    def __init__(self, model_path: str = "data/BIOMD0000000887.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lim2014HtlvIInfectionADynamicStruggleBetwBiomd0000000887Model = SbmlLim2014HtlvIInfectionADynamicStruggleBetweenViral
