...
"""Auto-generated SBML BioModule wrapper for Liebal2012 - B.subtilis sigB proteolysis model.

Source: biomodels_ebi:BIOMD0000000460
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000460
"""
...
class SbmlLiebal2012BSubtilisSigbProteolysisModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Liebal2012 - B.subtilis sigB proteolysis model."""

    def __init__(self, model_path: str = "data/BIOMD0000000460.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liebal2012BSubtilisSigbProteolysisModelBiomd0000000460Model = SbmlLiebal2012BSubtilisSigbProteolysisModel
