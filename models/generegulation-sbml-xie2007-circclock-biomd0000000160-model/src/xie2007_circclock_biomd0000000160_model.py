...
"""Auto-generated SBML BioModule wrapper for Xie2007_CircClock.

Source: biomodels_ebi:BIOMD0000000160
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000160
"""
...
class SbmlXie2007Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Xie2007_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000160.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Xie2007CircclockBiomd0000000160Model = SbmlXie2007Circclock
