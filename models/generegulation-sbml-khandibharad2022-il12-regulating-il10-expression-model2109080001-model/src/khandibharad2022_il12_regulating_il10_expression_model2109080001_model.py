...
"""Auto-generated SBML BioModule wrapper for Khandibharad2022 -  IL12 regulating IL10 expression in Leishmaniasis.

Source: biomodels_ebi:MODEL2109080001
Original: https://www.ebi.ac.uk/biomodels/MODEL2109080001
"""
...
class SbmlKhandibharad2022Il12RegulatingIl10ExpressionIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Khandibharad2022 -  IL12 regulating IL10 expression in Leishmaniasis."""

    def __init__(self, model_path: str = "data/MODEL2109080001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Khandibharad2022Il12RegulatingIl10ExpressionModel2109080001Model = SbmlKhandibharad2022Il12RegulatingIl10ExpressionIn
