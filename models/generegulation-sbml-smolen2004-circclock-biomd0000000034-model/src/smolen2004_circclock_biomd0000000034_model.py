...
"""Auto-generated SBML BioModule wrapper for Smolen2004_CircClock.

Source: biomodels_ebi:BIOMD0000000034
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000034
"""
...
class SbmlSmolen2004Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Smolen2004_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000034.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smolen2004CircclockBiomd0000000034Model = SbmlSmolen2004Circclock
