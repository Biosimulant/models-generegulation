...
"""Auto-generated SBML BioModule wrapper for Liebal2012 - B.subtilis post-transcriptional instability model.

Source: biomodels_ebi:BIOMD0000000459
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000459
"""
...
class SbmlLiebal2012BSubtilisPostTranscriptionalInstabilityModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Liebal2012 - B.subtilis post-transcriptional instability model."""

    def __init__(self, model_path: str = "data/BIOMD0000000459.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liebal2012BSubtilisPostTranscriptionalInstaBiomd0000000459Model = SbmlLiebal2012BSubtilisPostTranscriptionalInstabilityModel
