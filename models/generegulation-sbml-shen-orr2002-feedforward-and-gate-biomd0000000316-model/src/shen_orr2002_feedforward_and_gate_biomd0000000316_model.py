...
"""Auto-generated SBML BioModule wrapper for Shen-Orr2002_FeedForward_AND_gate.

Source: biomodels_ebi:BIOMD0000000316
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000316
"""
...
class SbmlShenOrr2002FeedforwardAndGate(biosim.BioModule):
    """BioModule wrapper for SBML model: Shen-Orr2002_FeedForward_AND_gate."""

    def __init__(self, model_path: str = "data/BIOMD0000000316.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ShenOrr2002FeedforwardAndGateBiomd0000000316Model = SbmlShenOrr2002FeedforwardAndGate
