...
"""Auto-generated SBML BioModule wrapper for Dhawan2019 - Endogenous miRNA sponges mediate the generation of oscillatory dynamics for a non-coding RNA network.

Source: biomodels_ebi:BIOMD0000000841
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000841
"""
...
class SbmlDhawan2019EndogenousMirnaSpongesMediateTheGeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Dhawan2019 - Endogenous miRNA sponges mediate the generation of oscillatory dynamics for a non-coding RNA network."""

    def __init__(self, model_path: str = "data/BIOMD0000000841.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dhawan2019EndogenousMirnaSpongesMediateTheBiomd0000000841Model = SbmlDhawan2019EndogenousMirnaSpongesMediateTheGeneration
