...
"""Auto-generated SBML BioModule wrapper for Rantasalo2016 - Synthetic expresion modulator induced STF_B42.

Source: biomodels_ebi:MODEL1510230004
Original: https://www.ebi.ac.uk/biomodels/MODEL1510230004
"""
...
class SbmlRantasalo2016SyntheticExpresionModulatorInducedStfB42(biosim.BioModule):
    """BioModule wrapper for SBML model: Rantasalo2016 - Synthetic expresion modulator induced STF_B42."""

    def __init__(self, model_path: str = "data/MODEL1510230004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rantasalo2016SyntheticExpresionModulatorInduModel1510230004Model = SbmlRantasalo2016SyntheticExpresionModulatorInducedStfB42
