...
"""Auto-generated SBML BioModule wrapper for Ashall2009 - NFkappaB dependent transcription.

Source: biomodels_ebi:MODEL1509020000
Original: https://www.ebi.ac.uk/biomodels/MODEL1509020000
"""
...
class SbmlAshall2009NfkappabDependentTranscription(bsim.BioModule):
    """BioModule wrapper for SBML model: Ashall2009 - NFkappaB dependent transcription."""

    def __init__(self, model_path: str = "data/MODEL1509020000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ashall2009NfkappabDependentTranscriptionModel1509020000Model = SbmlAshall2009NfkappabDependentTranscription
