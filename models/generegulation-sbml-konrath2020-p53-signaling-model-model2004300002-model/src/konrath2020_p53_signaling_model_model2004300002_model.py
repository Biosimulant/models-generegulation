...
"""Auto-generated SBML BioModule wrapper for Konrath2020_p53_signaling_model.

Source: biomodels_ebi:MODEL2004300002
Original: https://www.ebi.ac.uk/biomodels/MODEL2004300002
"""
...
class SbmlKonrath2020P53SignalingModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Konrath2020_p53_signaling_model."""

    def __init__(self, model_path: str = "data/MODEL2004300002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Konrath2020P53SignalingModelModel2004300002Model = SbmlKonrath2020P53SignalingModel
