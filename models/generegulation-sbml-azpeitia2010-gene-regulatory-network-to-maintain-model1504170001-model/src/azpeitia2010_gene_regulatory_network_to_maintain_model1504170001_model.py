...
"""Auto-generated SBML BioModule wrapper for Azpeitia2010 - Gene regulatory network to maintain the root  stem cell niche (RSCN_GRN_2010b).

Source: biomodels_ebi:MODEL1504170001
Original: https://www.ebi.ac.uk/biomodels/MODEL1504170001
"""
...
class SbmlAzpeitia2010GeneRegulatoryNetworkToMaintainTheRoot(biosim.BioModule):
    """BioModule wrapper for SBML model: Azpeitia2010 - Gene regulatory network to maintain the root  stem cell niche (RSCN_GRN_2010b)."""

    def __init__(self, model_path: str = "data/MODEL1504170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Azpeitia2010GeneRegulatoryNetworkToMaintainModel1504170001Model = SbmlAzpeitia2010GeneRegulatoryNetworkToMaintainTheRoot
