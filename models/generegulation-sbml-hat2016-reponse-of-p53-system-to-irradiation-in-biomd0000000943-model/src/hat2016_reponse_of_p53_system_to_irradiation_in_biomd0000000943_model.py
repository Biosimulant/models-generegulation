...
"""Auto-generated SBML BioModule wrapper for Hat2016 - Reponse of p53 System to irradiation in cell fate decision making.

Source: biomodels_ebi:BIOMD0000000943
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000943
"""
...
class SbmlHat2016ReponseOfP53SystemToIrradiationInCellFate(biosim.BioModule):
    """BioModule wrapper for SBML model: Hat2016 - Reponse of p53 System to irradiation in cell fate decision making."""

    def __init__(self, model_path: str = "data/BIOMD0000000943.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hat2016ReponseOfP53SystemToIrradiationInBiomd0000000943Model = SbmlHat2016ReponseOfP53SystemToIrradiationInCellFate
