...
"""Auto-generated SBML BioModule wrapper for Linke2017 - Synchronization of Cyclins' expression by the Fkh2 transcription factor in the budding yeast cell cycle.

Source: biomodels_ebi:BIOMD0000000934
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000934
"""
...
class SbmlLinke2017SynchronizationOfCyclinsExpressionByTheFkh2(biosim.BioModule):
    """BioModule wrapper for SBML model: Linke2017 - Synchronization of Cyclins' expression by the Fkh2 transcription factor in the budding yeast cell cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000934.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Linke2017SynchronizationOfCyclinsExpressionBiomd0000000934Model = SbmlLinke2017SynchronizationOfCyclinsExpressionByTheFkh2
