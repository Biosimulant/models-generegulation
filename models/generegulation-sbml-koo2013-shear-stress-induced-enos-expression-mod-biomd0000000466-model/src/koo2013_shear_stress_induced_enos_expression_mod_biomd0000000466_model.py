...
"""Auto-generated SBML BioModule wrapper for Koo2013 - Shear stress induced eNOS expression - Model 3.

Source: biomodels_ebi:BIOMD0000000466
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000466
"""
...
class SbmlKoo2013ShearStressInducedEnosExpressionModel3(biosim.BioModule):
    """BioModule wrapper for SBML model: Koo2013 - Shear stress induced eNOS expression - Model 3."""

    def __init__(self, model_path: str = "data/BIOMD0000000466.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koo2013ShearStressInducedEnosExpressionModBiomd0000000466Model = SbmlKoo2013ShearStressInducedEnosExpressionModel3
