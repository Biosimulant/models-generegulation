...
"""Auto-generated SBML BioModule wrapper for Azpeitia2010 - Gene regulatory network to maintain the root  stem cell niche (RSCN_GRN_2010d).

Source: biomodels_ebi:MODEL1504170003
Original: https://www.ebi.ac.uk/biomodels/MODEL1504170003
"""
...
class SbmlAzpeitia2010GeneRegulatoryNetworkToMaintainTheRoot2(biosim.BioModule):
    """BioModule wrapper for SBML model: Azpeitia2010 - Gene regulatory network to maintain the root  stem cell niche (RSCN_GRN_2010d)."""

    def __init__(self, model_path: str = "data/MODEL1504170003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Azpeitia2010GeneRegulatoryNetworkToMaintainModel1504170003Model = SbmlAzpeitia2010GeneRegulatoryNetworkToMaintainTheRoot2
