...
"""Auto-generated SBML BioModule wrapper for Azpeitia2010 - Gene regulatory network to maintain the root  stem cell niche (RSCN_GRN_2010a).

Source: biomodels_ebi:MODEL1504170000
Original: https://www.ebi.ac.uk/biomodels/MODEL1504170000
"""
...
class SbmlAzpeitia2010GeneRegulatoryNetworkToMaintainTheRoot(biosim.BioModule):
    """BioModule wrapper for SBML model: Azpeitia2010 - Gene regulatory network to maintain the root  stem cell niche (RSCN_GRN_2010a)."""

    def __init__(self, model_path: str = "data/MODEL1504170000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Azpeitia2010GeneRegulatoryNetworkToMaintainModel1504170000Model = SbmlAzpeitia2010GeneRegulatoryNetworkToMaintainTheRoot
