...
"""Auto-generated SBML BioModule wrapper for Lee2012_GeneExpression_tTA-doxInteraction.

Source: biomodels_ebi:MODEL1202270001
Original: https://www.ebi.ac.uk/biomodels/MODEL1202270001
"""
...
class SbmlLee2012GeneexpressionTtaDoxinteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2012_GeneExpression_tTA-doxInteraction."""

    def __init__(self, model_path: str = "data/MODEL1202270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2012GeneexpressionTtaDoxinteractionModel1202270001Model = SbmlLee2012GeneexpressionTtaDoxinteraction
