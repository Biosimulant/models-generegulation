...
"""Auto-generated SBML BioModule wrapper for Hu2020 - E. coli translation model.

Source: biomodels_ebi:MODEL2006210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2006210001
"""
...
class SbmlHu2020EColiTranslationModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Hu2020 - E. coli translation model."""

    def __init__(self, model_path: str = "data/MODEL2006210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hu2020EColiTranslationModelModel2006210001Model = SbmlHu2020EColiTranslationModel
