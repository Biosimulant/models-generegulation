...
"""Auto-generated SBML BioModule wrapper for Werner2005_IkappaB_kinase.

Source: biomodels_ebi:MODEL1008110000
Original: https://www.ebi.ac.uk/biomodels/MODEL1008110000
"""
...
class SbmlWerner2005IkappabKinase(biosim.BioModule):
    """BioModule wrapper for SBML model: Werner2005_IkappaB_kinase."""

    def __init__(self, model_path: str = "data/MODEL1008110000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Werner2005IkappabKinaseModel1008110000Model = SbmlWerner2005IkappabKinase
