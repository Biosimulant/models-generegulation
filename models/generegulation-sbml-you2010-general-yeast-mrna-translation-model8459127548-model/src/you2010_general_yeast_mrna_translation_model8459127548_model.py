...
"""Auto-generated SBML BioModule wrapper for You2010_General_Yeast_mRNA_Translation.

Source: biomodels_ebi:MODEL8459127548
Original: https://www.ebi.ac.uk/biomodels/MODEL8459127548
"""
...
class SbmlYou2010GeneralYeastMrnaTranslation(biosim.BioModule):
    """BioModule wrapper for SBML model: You2010_General_Yeast_mRNA_Translation."""

    def __init__(self, model_path: str = "data/MODEL8459127548.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
You2010GeneralYeastMrnaTranslationModel8459127548Model = SbmlYou2010GeneralYeastMrnaTranslation
