...
"""Auto-generated SBML BioModule wrapper for Liebal2012 - B.subtilis transcription inhibition model.

Source: biomodels_ebi:BIOMD0000000461
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000461
"""
...
class SbmlLiebal2012BSubtilisTranscriptionInhibitionModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Liebal2012 - B.subtilis transcription inhibition model."""

    def __init__(self, model_path: str = "data/BIOMD0000000461.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liebal2012BSubtilisTranscriptionInhibitionMBiomd0000000461Model = SbmlLiebal2012BSubtilisTranscriptionInhibitionModel
