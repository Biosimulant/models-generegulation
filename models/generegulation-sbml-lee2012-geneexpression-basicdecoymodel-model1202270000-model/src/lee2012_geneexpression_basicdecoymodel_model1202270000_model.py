...
"""Auto-generated SBML BioModule wrapper for Lee2012_GeneExpression_BasicDecoyModel.

Source: biomodels_ebi:MODEL1202270000
Original: https://www.ebi.ac.uk/biomodels/MODEL1202270000
"""
...
class SbmlLee2012GeneexpressionBasicdecoymodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2012_GeneExpression_BasicDecoyModel."""

    def __init__(self, model_path: str = "data/MODEL1202270000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2012GeneexpressionBasicdecoymodelModel1202270000Model = SbmlLee2012GeneexpressionBasicdecoymodel
