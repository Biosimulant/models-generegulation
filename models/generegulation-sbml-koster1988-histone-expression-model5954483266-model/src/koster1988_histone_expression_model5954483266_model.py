...
"""Auto-generated SBML BioModule wrapper for Koster1988_Histone_Expression.

Source: biomodels_ebi:MODEL5954483266
Original: https://www.ebi.ac.uk/biomodels/MODEL5954483266
"""
...
class SbmlKoster1988HistoneExpression(biosim.BioModule):
    """BioModule wrapper for SBML model: Koster1988_Histone_Expression."""

    def __init__(self, model_path: str = "data/MODEL5954483266.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koster1988HistoneExpressionModel5954483266Model = SbmlKoster1988HistoneExpression
