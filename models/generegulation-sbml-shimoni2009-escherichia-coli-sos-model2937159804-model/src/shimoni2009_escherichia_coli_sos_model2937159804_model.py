...
"""Auto-generated SBML BioModule wrapper for Shimoni2009 - Escherichia Coli SOS.

Source: biomodels_ebi:MODEL2937159804
Original: https://www.ebi.ac.uk/biomodels/MODEL2937159804
"""
...
class SbmlShimoni2009EscherichiaColiSos(biosim.BioModule):
    """BioModule wrapper for SBML model: Shimoni2009 - Escherichia Coli SOS."""

    def __init__(self, model_path: str = "data/MODEL2937159804.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shimoni2009EscherichiaColiSosModel2937159804Model = SbmlShimoni2009EscherichiaColiSos
