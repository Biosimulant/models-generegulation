...
"""Auto-generated SBML BioModule wrapper for Floc&#39;hlay2020 - SeaUrchin_model_ginsim.

Source: biomodels_ebi:MODEL2002190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2002190001
"""
...
class SbmlFloc39Hlay2020SeaurchinModelGinsim(biosim.BioModule):
    """BioModule wrapper for SBML model: Floc&#39;hlay2020 - SeaUrchin_model_ginsim."""

    def __init__(self, model_path: str = "data/MODEL2002190001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Flocand39Hlay2020SeaurchinModelGinsimModel2002190001Model = SbmlFloc39Hlay2020SeaurchinModelGinsim
