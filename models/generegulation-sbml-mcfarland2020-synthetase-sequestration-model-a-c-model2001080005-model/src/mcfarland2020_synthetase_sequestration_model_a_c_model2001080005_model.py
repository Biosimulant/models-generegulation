...
"""Auto-generated SBML BioModule wrapper for McFarland2020 - Synthetase sequestration Model:a combined translation and tRNA charging cycle.

Source: biomodels_ebi:MODEL2001080005
Original: https://www.ebi.ac.uk/biomodels/MODEL2001080005
"""
...
class SbmlMcfarland2020SynthetaseSequestrationModelACombined(biosim.BioModule):
    """BioModule wrapper for SBML model: McFarland2020 - Synthetase sequestration Model:a combined translation and tRNA charging cycle."""

    def __init__(self, model_path: str = "data/MODEL2001080005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mcfarland2020SynthetaseSequestrationModelACModel2001080005Model = SbmlMcfarland2020SynthetaseSequestrationModelACombined
