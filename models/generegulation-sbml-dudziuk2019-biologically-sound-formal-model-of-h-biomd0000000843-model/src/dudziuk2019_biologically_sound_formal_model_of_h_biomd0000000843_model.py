...
"""Auto-generated SBML BioModule wrapper for Dudziuk2019 - Biologically sound formal model of Hsp70 heat induction.

Source: biomodels_ebi:BIOMD0000000843
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000843
"""
...
class SbmlDudziuk2019BiologicallySoundFormalModelOfHsp70Heat(biosim.BioModule):
    """BioModule wrapper for SBML model: Dudziuk2019 - Biologically sound formal model of Hsp70 heat induction."""

    def __init__(self, model_path: str = "data/BIOMD0000000843.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dudziuk2019BiologicallySoundFormalModelOfHBiomd0000000843Model = SbmlDudziuk2019BiologicallySoundFormalModelOfHsp70Heat
