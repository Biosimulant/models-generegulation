...
"""Auto-generated SBML BioModule wrapper for Yildirim2003_Lac_Operon.

Source: biomodels_ebi:BIOMD0000000065
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000065
"""
...
class SbmlYildirim2003LacOperon(biosim.BioModule):
    """BioModule wrapper for SBML model: Yildirim2003_Lac_Operon."""

    def __init__(self, model_path: str = "data/BIOMD0000000065.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yildirim2003LacOperonBiomd0000000065Model = SbmlYildirim2003LacOperon
