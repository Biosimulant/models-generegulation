...
"""Auto-generated SBML BioModule wrapper for Cao2010 - Epigenetic state of lysogeny in phage lambda.

Source: biomodels_ebi:MODEL1308080003
Original: https://www.ebi.ac.uk/biomodels/MODEL1308080003
"""
...
class SbmlCao2010EpigeneticStateOfLysogenyInPhageLambda(biosim.BioModule):
    """BioModule wrapper for SBML model: Cao2010 - Epigenetic state of lysogeny in phage lambda."""

    def __init__(self, model_path: str = "data/MODEL1308080003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cao2010EpigeneticStateOfLysogenyInPhageLaModel1308080003Model = SbmlCao2010EpigeneticStateOfLysogenyInPhageLambda
