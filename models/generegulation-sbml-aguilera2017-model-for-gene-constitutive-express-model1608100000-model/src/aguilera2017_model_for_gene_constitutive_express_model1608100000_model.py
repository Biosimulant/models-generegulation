...
"""Auto-generated SBML BioModule wrapper for Aguilera2017 - Model for gene constitutive expression circuit.

Source: biomodels_ebi:MODEL1608100000
Original: https://www.ebi.ac.uk/biomodels/MODEL1608100000
"""
...
class SbmlAguilera2017ModelForGeneConstitutiveExpressionCircuit(biosim.BioModule):
    """BioModule wrapper for SBML model: Aguilera2017 - Model for gene constitutive expression circuit."""

    def __init__(self, model_path: str = "data/MODEL1608100000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aguilera2017ModelForGeneConstitutiveExpressModel1608100000Model = SbmlAguilera2017ModelForGeneConstitutiveExpressionCircuit
