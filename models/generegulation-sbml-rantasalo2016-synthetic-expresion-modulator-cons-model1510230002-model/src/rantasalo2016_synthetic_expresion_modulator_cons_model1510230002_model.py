...
"""Auto-generated SBML BioModule wrapper for Rantasalo2016 - Synthetic expresion modulator constitutive STF_B42.

Source: biomodels_ebi:MODEL1510230002
Original: https://www.ebi.ac.uk/biomodels/MODEL1510230002
"""
...
class SbmlRantasalo2016SyntheticExpresionModulatorConstitutive2(biosim.BioModule):
    """BioModule wrapper for SBML model: Rantasalo2016 - Synthetic expresion modulator constitutive STF_B42."""

    def __init__(self, model_path: str = "data/MODEL1510230002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rantasalo2016SyntheticExpresionModulatorConsModel1510230002Model = SbmlRantasalo2016SyntheticExpresionModulatorConstitutive2
