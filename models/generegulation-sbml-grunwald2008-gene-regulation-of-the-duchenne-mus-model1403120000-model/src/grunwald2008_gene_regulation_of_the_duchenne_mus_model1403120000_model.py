...
"""Auto-generated SBML BioModule wrapper for Grunwald2008 - Gene regulation of the Duchenne muscular dystrophy (Petri-net model).

Source: biomodels_ebi:MODEL1403120000
Original: https://www.ebi.ac.uk/biomodels/MODEL1403120000
"""
...
class SbmlGrunwald2008GeneRegulationOfTheDuchenneMuscular(biosim.BioModule):
    """BioModule wrapper for SBML model: Grunwald2008 - Gene regulation of the Duchenne muscular dystrophy (Petri-net model)."""

    def __init__(self, model_path: str = "data/MODEL1403120000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Grunwald2008GeneRegulationOfTheDuchenneMusModel1403120000Model = SbmlGrunwald2008GeneRegulationOfTheDuchenneMuscular
