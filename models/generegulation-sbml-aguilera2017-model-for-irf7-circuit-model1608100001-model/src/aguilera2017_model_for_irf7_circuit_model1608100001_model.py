...
"""Auto-generated SBML BioModule wrapper for Aguilera2017 - Model for IRF7 circuit.

Source: biomodels_ebi:MODEL1608100001
Original: https://www.ebi.ac.uk/biomodels/MODEL1608100001
"""
...
class SbmlAguilera2017ModelForIrf7Circuit(biosim.BioModule):
    """BioModule wrapper for SBML model: Aguilera2017 - Model for IRF7 circuit."""

    def __init__(self, model_path: str = "data/MODEL1608100001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aguilera2017ModelForIrf7CircuitModel1608100001Model = SbmlAguilera2017ModelForIrf7Circuit
