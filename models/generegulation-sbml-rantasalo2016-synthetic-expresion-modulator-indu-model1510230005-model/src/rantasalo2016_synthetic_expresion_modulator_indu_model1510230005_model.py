...
"""Auto-generated SBML BioModule wrapper for Rantasalo2016 - Synthetic expresion modulator induced STF_VP16.

Source: biomodels_ebi:MODEL1510230005
Original: https://www.ebi.ac.uk/biomodels/MODEL1510230005
"""
...
class SbmlRantasalo2016SyntheticExpresionModulatorInducedStfVp16(biosim.BioModule):
    """BioModule wrapper for SBML model: Rantasalo2016 - Synthetic expresion modulator induced STF_VP16."""

    def __init__(self, model_path: str = "data/MODEL1510230005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rantasalo2016SyntheticExpresionModulatorInduModel1510230005Model = SbmlRantasalo2016SyntheticExpresionModulatorInducedStfVp16
