...
"""Auto-generated SBML BioModule wrapper for Zeilinger2006_PRR7-PRR9light-Yprime.

Source: biomodels_ebi:BIOMD0000000097
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000097
"""
...
class SbmlZeilinger2006Prr7Prr9lightYprime(biosim.BioModule):
    """BioModule wrapper for SBML model: Zeilinger2006_PRR7-PRR9light-Yprime."""

    def __init__(self, model_path: str = "data/BIOMD0000000097.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zeilinger2006Prr7Prr9lightYprimeBiomd0000000097Model = SbmlZeilinger2006Prr7Prr9lightYprime
