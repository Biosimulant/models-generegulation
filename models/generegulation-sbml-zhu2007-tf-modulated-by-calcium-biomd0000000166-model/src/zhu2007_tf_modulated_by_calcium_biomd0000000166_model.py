...
"""Auto-generated SBML BioModule wrapper for Zhu2007_TF_modulated_by_Calcium.

Source: biomodels_ebi:BIOMD0000000166
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000166
"""
...
class SbmlZhu2007TfModulatedByCalcium(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhu2007_TF_modulated_by_Calcium."""

    def __init__(self, model_path: str = "data/BIOMD0000000166.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhu2007TfModulatedByCalciumBiomd0000000166Model = SbmlZhu2007TfModulatedByCalcium
